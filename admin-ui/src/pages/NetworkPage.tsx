...
import type { AnalyticsOverview, TimeRange } from "@/shared/types";
...
export function NetworkPage() {
  ...
  const series = useTimeseries(TIMESERIES_METRIC, range);
      ...
      <Card>
        <CardHeader className="flex flex-row items-start justify-between gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <CardDescription>
              Mod logins, bucketed over the selected range.
            </CardDescription>
          </div>
        ...
        <CardContent>
          {series.isLoading ? (
            ...
            <EmptyChartState
              ...
              detail="The timeseries request failed. Try another range."
            />
          ) : !hasData ? (
            <EmptyChartState
